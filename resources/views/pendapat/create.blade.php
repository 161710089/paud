...
@section('content')
    ...
    @foreach($sekolahs as $data)
      <title>{{ $data->nama_sekolah }} - Taman kanak-kanak | Pendapat | Create </title>
    @endforeach
...
<div class="page-breadcrumb">
      ...
      <form action="{{route('pendapat.store')}}" enctype="multipart/form-data" method="post">
              {{csrf_field()}}
        <div class="row md-3">
...
<div class="form-group {{ $errors->has('pendapat') ? 'has error' : ''}} ">
              ...
              <textarea name="pendapat" id="deskripsi" class="form-control"></textarea>
