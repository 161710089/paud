	...
	<div class="row">
		<div class="container">
            ...
            @foreach($sekolahs as $data)
             <title>{{ $data->nama_sekolah }} - Taman kanak-kanak | KAtegori Artikel | Create</title>
            @endforeach
...
<div class="page-breadcrumb">
			...
			<form action="{{route('kategori_artikel.store')}}" enctype="multipart/form-data" method="post">
							{{csrf_field()}}
