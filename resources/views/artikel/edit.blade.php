...
.image-preview-input-title {
    ...
    @foreach($sekolahs as $data)
      <title>{{ $data->nama_sekolah }} - Taman kanak-kanak | Artikel | Edit </title>
    @endforeach
...
<div class="page-breadcrumb">
     ...
     <form action="{{ route('artikel.update',$tb_m_artikel->id) }}" method="post" enctype="multipart/form-data" >
...
<div class="form-group {{ $errors->has('deskripsi') ? 'has error' : ''}} ">
              ...
              <textarea name="deskripsi" id="deskripsi" class="form-control"> {{ $tb_m_artikel->deskripsi }} </textarea>
