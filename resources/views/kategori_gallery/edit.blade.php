...
@section('content')
	<div class="row">
      ...
      @foreach($sekolahs as $data)
        <title>{{ $data->nama_sekolah }} - Taman kanak-kanak | Kategori Gallery | Edit </title>
      @endforeach
...
<div class="page-breadcrumb">
            ...
            <form action="{{ route('kategori_gallery.update',$tb_m_kategori_gallery->id) }}" 
                    ...
                    {{ csrf_field() }}
  	                    <div class="col-md-6 col-lg-4 col-xlg-3">
                            <div class="form-group {{$errors->has('kategori') ? 'has-error' : ''}}">
                                ...
                                <input type="text"  class="form-control" value="{{ $tb_m_kategori_gallery->kategori }}" name="kategori">
...
function(isConfirm) {
    if (isConfirm) {
       $.ajax({
               type:'get',
               url:'<?php echo url("kategori_gallery.update"); ?>/'+id,
