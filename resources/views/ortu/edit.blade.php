		...
		<div class="container">
			...
			<form action="{{ route('ortu.update',$tb_m_ortu->id) }}" method="post" enctype="multipart/form-data" >
			  	...
			  	<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class="form-group {{$errors->has('nama_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_ortu->nama_ayah }}" class="form-control" name="nama_ayah" required>
			...
			<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class="form-group {{$errors->has('ttl_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" class="form-control" value="{{ $tb_m_ortu->ttl_ayah }}" name="ttl_ayah" required>
			...
			<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class="form-group {{$errors->has('agama_ayah') ? 'has-error' : ''}}">
								<label class="control-label">Tempat Tanggal Lahir</label>
								<input type="text" class="form-control" value="{{ $tb_m_ortu->agama_ayah }}" name="agama_ayah" required>
			...
			<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class="form-group {{$errors->has('kewarganegaraan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" class="form-control" value="{{ $tb_m_ortu->kewarganegaraan_ayah }}" name="kewarganegaraan_ayah" required>
...
<h3>Alamat</h3>
					...
					<div class="form-group {{$errors->has('nik_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" class="form-control" value="{{ $tb_m_ortu->nik_ayah }}" name="nik_ayah" required>
						...
						<div class="form-group {{$errors->has('pendidikan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" class="form-control" value="{{ $tb_m_ortu->pendidikan_ayah }}" name="pendidikan_ayah" required>
					...
					<div class="form-group {{$errors->has('pekerjaan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" class="form-control" value="{{ $tb_m_ortu->pekerjaan_ayah }}" name="pekerjaan_ayah" required>
					...
					<div class="form-group {{$errors->has('penghasilan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" class="form-control" value="{{ $tb_m_ortu->penghasilan_ayah }}" name="penghasilan_ayah" required>
					...
					<div class="form-group {{$errors->has('alamat_no_telepon_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" class="form-control" value="{{ $tb_m_ortu->alamat_no_telepon_ayah }}" name="alamat_no_telepon_ayah" required>
...
<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class="form-group {{$errors->has('nama_ibu') ? 'has-error' : ''}}">
								<label class="control-label">Nama </label>
								<input type="text" value="{{ $tb_m_ortu->nama_ibu }}" class="form-control" name="nama_ibu" required>
			...
			<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class="form-group {{$errors->has('ttl_ibu') ? 'has-error' : ''}}">
								<label class="control-label">Tempat Tanggal Lahir</label>
								<input type="text" class="form-control" value="{{ $tb_m_ortu->ttl_ibu }}" name="ttl_ibu" required>
			...
			<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class="form-group {{$errors->has('agama_ibu') ? 'has-error' : ''}}">
								<label class="control-label">Tempat Tanggal Lahir</label>
								<input type="text" class="form-control" value="{{ $tb_m_ortu->agama_ibu }}" name="agama_ibu" required>
			...
			<div class="col-md-6 col-lg-4 col-xlg-3">
					<div class="form-group {{$errors->has('kewarganegaraan_ibu') ? 'has-error' : ''}}">
								<label class="control-label">Agama</label>
								<input type="text" class="form-control" value="{{ $tb_m_ortu->kewarganegaraan_ibu }}" name="kewarganegaraan_ibu" required>
...
<h3>Alamat</h3>
					...
					<div class="form-group {{$errors->has('nik_ibu') ? 'has-error' : ''}}">
								<label class="control-label">Kewarganegaraan</label>
								<input type="text" class="form-control" value="{{ $tb_m_ortu->nik_ibu }}" name="nik_ibu" required>
						...
						<div class="form-group {{$errors->has('pendidikan_ibu') ? 'has-error' : ''}}">
								<label class="control-label">Pendidikan</label>
								<input type="text" class="form-control" value="{{ $tb_m_ortu->pendidikan_ibu }}" name="pendidikan_ibu" required>
