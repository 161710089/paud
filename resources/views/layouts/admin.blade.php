                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{ route('dashboard') }}">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                        <img src="{{ asset('img/FotoSekolah/'.$sekolah->logo) }}" style="max-height:75px; min-width:35; max-height:75;   max-width: 35px; margin-top:7px;">   
                        </b>
                        <!--End Logo icon -->
                         <!-- Logo text -->
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-circle" src="{{ asset('img/Fotosiswa/'.$data->foto) }}" style="min-height:50px; min-width:50px;   max-height:50px; max-width:50px; margin-top:7px;">
                                @endforeach
                                @endrole
                                </a>
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <a class="dropdown-item" href="{{ route('widget.index') }}"><i class="mdi mdi-widgets"></i> Widget</a>
                        ...
                        @csrf
                                ...
                                <div class="p-l-30 p-10">
                                    @role('user')
                                    <a href="{{ Route('profile') }}" class="btn btn-sm btn-success btn-rounded">
                                        View Profile
                                    </a>
                                    @endrole
                                    @role('admin')
            ...
            <div class="scroll-sidebar">
             ...
             <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('service.index')  }}" aria-expanded="false"><i class="mdi mdi-wrench"></i><span class="hide-menu">Data Service</span></a></li>
                         ...
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('ticket.index')  }}" aria-expanded="false"><i class="mdi mdi-ticket"></i><span class="hide-menu">Data Tiket</span></a></li>
                         ...
                         <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('pendapat_user.index')  }}" aria-expanded="false"><i class="far fa-comments"></i><span class="hide-menu">Komentar Web</span></a></li>

                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('about.index')  }}" aria-expanded="false"><i class="mdi mdi-information-outline"></i><span class="hide-menu">About</span></a></li>


                       @endrole

                       @role('user')
                       <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('absensi')  }}" aria-expanded="false"><i class="mdi mdi-pen"></i><span class="hide-menu">Data Absensi</span></a></li>
                        
                       <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('profile')  }}" aria-expanded="false"><i class=" fas fa-users"></i><span class="hide-menu">Data Profile <span class="text-center">
                       ...
                       <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('tiket')  }}" aria-expanded="false"><i class="mdi mdi-ticket"></i><span class="hide-menu">Data Tiket</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{route('komentar-web')  }}" aria-expanded="false"><i class="far fa-comment"></i><span class="hide-menu">Berikan Komentar</span></a></li>
                       @endrole
                    </ul>
                       </nav>
