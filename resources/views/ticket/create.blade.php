...
@section('content')
    ...
    @foreach($sekolahs as $data)
      <title>{{ $data->nama_sekolah }} - Taman kanak-kanak | Ticket | Create </title>
    @endforeach
...
<div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Tambah ticket</h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{Route('dashboard') }}">Home</a></li>
                                    <li class="breadcrumb-item"><a href="{{Route('ticket.index') }}">ticket</a></li>
                                    <li class="breadcrumb-item active" aria-current="page"> Tambah ticket</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
   ...
   <div class="input-group">
              ...
              @if ($errors->has('id_event'))
                ...
                <div class="col-md-6 col-lg-4 col-xlg-2">
                    <div class=" {{$errors->has('jumlah_tiket_tersedia') ? 'has-error' : ''}}">
                                ...
                                <input type="number" class="form-control" name="jumlah_tiket_tersedia" required>
            ...
            <div class="col-md-6 col-lg-4 col-xlg-2">
                    <div class=" {{$errors->has('tersedia_tanggal') ? 'has-error' : ''}}">
                                ...
                                <input type="text" value="{{ carbon\carbon::now()->toDateString() }}"  class="form-control date" id="time" name="tersedia_tanggal" >
            ...
            <div class="col-md-6 col-lg-4 col-xlg-2">
                    <div class=" {{$errors->has('sampai_tanggal') ? 'has-error' : ''}}">
                                ...
                                <input type="text" value="{{ carbon\carbon::tomorrow()->toDateString() }}" class="form-control date" id="time2" name="sampai_tanggal" >
