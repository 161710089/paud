...
@section('content')
    ...
    @foreach($sekolahs as $data)
      <title>{{ $data->nama_sekolah }} - Taman kanak-kanak | Gallery | Edit</title>
    @endforeach
...
<div class="page-breadcrumb">
			...
			<form action="{{ route('gallery.update',$tb_m_gallery->id) }}" 
...
<div class="col-md-6 col-lg-4 col-xlg-3">
                    <div class="form-group {{$errors->has('judul') ? 'has-error' : ''}}">
                                ...
                                <input type="text" value="{{ $tb_m_gallery->judul }}" class="form-control" name="judul">
                                @if ($errors->has('judul'))
...
<div class="col-md-6 col-lg-4 col-xlg-2">                   
   ...
   <div class="input-group">
              ...
              <select name="id_kategori_gallery" class="form-control" >
                ...
                <option value="{{ $data->id }}"{{$selectkategoriGallery == $data->id ? 'selected="selected"':'' }} required>{{ 
