               ...
               <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Pengajar</h4>
...
<form method="GET" action="pengajar" class="form-control" role="search" >
...
<form method="GET" action="siswa" class="form-control" role="search" >
 ...
 --}}</div> 
        ...
        <div class="panel-heading"><a class="btn btn-secondary"  href="{{ route('pengajar.create') }}"><i class="mdi mdi-plus"></i> Tambah data Pengajar</a> 
        </div>
{{-- @if(count($tb_m_pengajar)>0) 
        <br><br><br><br><br>
<center>
					...
					<div class="col-md-4 col-lg-auto col-xlg-3">
                        <div class="card card-hover" id="myTable">
                            <div class="box bg-light ">
                                <h1 class="font-light text-black text-center"><img class="img-circle" src="{{ asset('img/Fotopengajar/'.$data->foto) }}" style="min-height:175px; min-width:185px;   max-height:175px; max-width:185px; margin-top:7px;"></h1>
                               <a href="{{ route('pengajar.show',$data->id) }}"><h6 class="text-black text-center">{{ $data->nama }}</h6></a>
...
@endif --}}                    </div>
        {{ $tb_m_pengajar->appends(request()->input())->links() }}  
