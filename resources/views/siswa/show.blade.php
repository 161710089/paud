                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Show Siswa</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
		...
		<div class="col-md-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<div class="row mb-3">
						<a class="btn btn-primary" href="{{route('siswa.edit',$tb_m_siswa->id)}}"><i class="mdi mdi-pencil"></i></a>&nbsp;
						<button onclick="deleteSiswa('{{$tb_m_siswa->id}}')" class="btn btn-danger"><i class="mdi mdi-delete"></i></button>
					     &nbsp;	
					...
					<div class="row mb-3">
			  			<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('nama_lengkap') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->nama_lengkap }}" class="form-control"  name="nama_lengkap" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">				
							<div class=" {{$errors->has('email') ? 'has-error' : ''}}">
								<label >Email</label>
								<input type="text" value="{{ $tb_m_siswa->user->email }}" class="form-control" name="email" readonly>
								@if ($errors->has('email'))
									<span class="help-blocks">
 						...
 						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{ $errors->has('jenis_kelamin') ? ' has-error' : '' }}">
								...
								value="Laki-laki" {{ $tb_m_siswa->jenis_kelamin == 'Laki-laki' ? 'checked' : '' }} disabled>Laki laki&nbsp&nbsp
								<input type="radio" class="radio-control" name="jenis_kelamin"  
								value="Perempuan" {{ $tb_m_siswa->jenis_kelamin == 'Perempuan' ? 'checked' : '' }} disabled>Perempuan&nbsp&nbsp
					...
					<div class="row mb-3">
						 <div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('nama_ayah') ? 'has-error' : ''}}">
								<label >Nama </label>
								<input type="text"  value="{{ $tb_m_siswa->tb_m_ortu->nama_ayah }}" class="form-control" name="nama_ayah" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('ttl_ayah') ? 'has-error' : ''}}">
								<label >Tempat Tanggal Lahir</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->ttl_ayah }}" class="form-control"  name="ttl_ayah" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('agama_ayah') ? 'has-error' : ''}}">
								<label >Agama</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->agama_ayah }}" class="form-control"  name="agama_ayah" readonly>
					...
					<div class="row mb-3">		
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('kewarganegaraan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->kewarganegaraan_ayah }}" class="form-control"  
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('pendidikan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->pendidikan_ayah }}" class="form-control"  name="pendidikan_ayah" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('pekerjaan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->pekerjaan_ayah }}" class="form-control"  name="pekerjaan_ayah" readonly>
					...
					<div class="row mb-3">		
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('penghasilan_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->penghasilan_ibu }}" class="form-control" ] name="penghasilan_ayah" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('alamat_no_telepon_ayah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->alamat_no_telepon_ayah }}" class="form-control"  name="alamat_no_telepon_ayah" readonly>
					...
					<div class="row mb-3">
						 <div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('nama_ibu') ? 'has-error' : ''}}">
								<label >Nama </label>
								<input type="text"  value="{{ $tb_m_siswa->tb_m_ortu->nama_ibu }}" class="form-control" name="nama_ibu" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('ttl_ibu') ? 'has-error' : ''}}">
								<label >Tempat Tanggal Lahir</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->ttl_ibu }}" class="form-control"  name="ttl_ibu" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('agama_ibu') ? 'has-error' : ''}}">
								<label >Agama</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->agama_ibu }}" class="form-control"  name="agama_ibu" readonly>
					...
					<div class="row mb-3">		
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('kewarganegaraan_ibu') ? 'has-error' : ''}}">
								<label >Kewarganegaraan</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->kewarganegaraan_ibu }}" class="form-control"  name="kewarganegaraan_ibu" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('pendidikan_ibu') ? 'has-error' : ''}}">
								<label >Pendidikan</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->pendidikan_ibu }}" class="form-control"  name="pendidikan_ibu" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('pekerjaan_ibu') ? 'has-error' : ''}}">
								<label >Pekerjaan</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->pekerjaan_ibu }}" class="form-control"  name="pekerjaan_ibu" readonly>
					...
					<div class="row mb-3">		
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('penghasilan_ibu') ? 'has-error' : ''}}">
								<label >Penghasilan/Bulan</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->penghasilan_ibu }}" class="form-control" ] name="penghasilan_ibu" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('alamat_no_telepon_ibu') ? 'has-error' : ''}}">
								<label >Alamat dan No Telepon </label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->alamat_no_telepon_ibu }}" class="form-control"  name="alamat_no_telepon_ibu" readonly>
					...
					<div class="row mb-3">
						 <div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('nama_wali') ? 'has-error' : ''}}">
								<label >Nama </label>
								<input type="text"  value="{{ $tb_m_siswa->tb_m_ortu->nama_wali }}" class="form-control" name="nama_wali" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('ttl_wali') ? 'has-error' : ''}}">
								<label >Tempat Tanggal Lahir</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->ttl_wali }}" class="form-control"  name="ttl_wali" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('agama_wali') ? 'has-error' : ''}}">
								<label >Agama</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->agama_wali }}" class="form-control"  name="agama_wali" readonly>
					...
					<div class="row mb-3">		
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('kewarganegaraan_wali') ? 'has-error' : ''}}">
								<label >Kewarganegaraan</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->kewarganegaraan_wali }}" class="form-control"  name="kewarganegaraan_wali" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('pendidikan_wali') ? 'has-error' : ''}}">
								<label >Pendidikan</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->pendidikan_wali }}" class="form-control"  name="pendidikan_wali" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('pekerjaan_wali') ? 'has-error' : ''}}">
								<label >Pekerjaan</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->pekerjaan_wali }}" class="form-control"  name="pekerjaan_wali" readonly>
					...
					<div class="row mb-3">		
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('penghasilan_wali') ? 'has-error' : ''}}">
								<label >Penghasilan/Bulan</label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->penghasilan_ibu }}" class="form-control" ] name="penghasilan_wali" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('alamat_no_telepon_wali') ? 'has-error' : ''}}">
								<label >Alamat dan No Telepon </label>
								<input type="text" value="{{ $tb_m_siswa->tb_m_ortu->alamat_no_telepon_wali }}" class="form-control"  name="alamat_no_telepon_wali" readonly>
					...
					<div class="row mb-3">
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('nama_panggilan') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->nama_panggilan }}" class="form-control" name="nama_panggilan" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">	
							<div class=" {{$errors->has('nama_jalan') ? 'has-error' : ''}}">
								<label >Jalan</label>
								<input type="text" value="{{ $tb_m_siswa->nama_jalan }}" class="form-control" name="nama_jalan" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('nama_desa') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->nama_desa }}" class="form-control" name="nama_desa" readonly>
					...
					<div class="row mb-3">
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('kecamatan') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->kecamatan }}" class="form-control" name="kecamatan" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('kabupaten') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->kabupaten }}" class="form-control" name="kabupaten" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('provinsi') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->provinsi }}" class="form-control" name="provinsi" readonly>
					...
					<div class="row mb-3">
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('agama') ? 'has-error' : ''}}">
								<label >Agama</label>
								<input type="text" value="{{ $tb_m_siswa->agama }}" class="form-control" name="agama" readonly>
								@if ($errors->has('agama'))
									<span class="help-blocks">
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('kewarganegaraan') ? 'has-error' : ''}}">
								<label >Kewarganegaraan</label>
								<input type="text" value="{{ $tb_m_siswa->kewarganegaraan }}" class="form-control" name="kewarganegaraan" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('anak_ke') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->anak_ke }}" class="form-control" name="anak_ke" readonly>
					...
					<div class="row mb-3">
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('jumlah_saudara_kandung') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->jumlah_saudara_kandung }}" class="form-control" name="jumlah_saudara_kandung" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('jumlah_saudara_tiri') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->jumlah_saudara_tiri }}" class="form-control" name="jumlah_saudara_tiri" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('jumlah_saudara_angkat') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->jumlah_saudara_angkat }}" class="form-control" name="jumlah_saudara_angkat" readonly>
					...
					<div class="row mb-3">
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('status_yatim') ? 'has-error' : ''}}">
								...
								value="Yatim" {{ $tb_m_siswa->status_yatim == 'Yatim' ? 'checked' : '' }} disabled>Yatim&nbsp&nbsp
								<input type="radio" class="radio-control" name="status_yatim"  
								value="Piatu" {{ $tb_m_siswa->status_yatim == 'Piatu' ? 'checked' : '' }} disabled>Piatu&nbsp&nbsp
								<input type="radio" class="radio-control" name="status_yatim" 
								value="Yatim Piatu" {{ $tb_m_siswa->status_yatim == 'Yatim Piatu' ? 'checked' : '' }} disabled>Yatim Piatu&nbsp&nbsp
								<input type="radio" class="radio-control" name="status_yatim"  
								value="-" {{ $tb_m_siswa->status_yatim == '-' ? 'checked' : '' }} disabled>-&nbsp&nbsp			
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
		 					<div class=" {{$errors->has('bahasa') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->bahasa }}" class="form-control" name="bahasa" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('golongan_darah') ? 'has-error' : ''}}">
								...
								value="A" {{ $tb_m_siswa->golongan_darah == 'A' ? 'checked' : '' }} disabled>A
								&nbsp&nbsp
								<input type="radio" class="radio-control" name="golongan_darah"  
								value="B" {{ $tb_m_siswa->golongan_darah == 'B' ? 'checked' : '' }} disabled>B
								&nbsp&nbsp
								<input type="radio" class="radio-control" name="golongan_darah" 
								value="AB" {{ $tb_m_siswa->golongan_darah == 'AB' ? 'checked' : '' }} disabled>AB
								&nbsp&nbsp
								<input type="radio" class="radio-control" name="golongan_darah"  
								value="O" {{ $tb_m_siswa->golongan_darah == 'O' ? 'checked' : '' }} disabled>O
								&nbsp&nbsp
					...
					<div class="row mb-3">
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('penyakit') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->penyakit }}" class="form-control" name="penyakit" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('imunisasi') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->imunisasi }}" class="form-control" name="imunisasi" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('ciri_ciri') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->ciri_ciri }}" class="form-control" name="ciri_ciri" readonly>
					...
					<div class="row mb-3">
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('tinggi_berat_badan') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tinggi_berat_badan }}" class="form-control" name="tinggi_berat_badan" readonly>
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('jarak_rumah') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->jarak_rumah }}" class="form-control" name="jarak_rumah" readonly>
