...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.4.1/css/
	...
	@foreach($sekolahs as $data)
      <title>{{ $data->nama_sekolah }} - Taman kanak-kanak | Siswa | Edit </title>
    @endforeach
					...
					<div class="row mb-3">
						...
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('nik') ? 'has-error' : ''}}">
								...
								<input type="number" value="{{ $tb_m_siswa->nik }}" 
					...
					<div class="row mb-3">
						<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('tempat_lahir') ? 'has-error' : ''}}">
								<label class="control-label">Tempat tempat Lahir</label>
								<input type="text" value="{{ $tb_m_siswa->tempat_lahir }}" class="form-control date" name="tempat_lahir" required>
			  			...
			  			<div class="col-md-6 col-lg-4 col-xlg-3">
							<div class=" {{$errors->has('tanggal_lahir') ? 'has-error' : ''}}">
								...
								<input type="text" value="{{ $tb_m_siswa->tanggal_lahir }}" class="form-control date" name="tanggal_lahir" required>
