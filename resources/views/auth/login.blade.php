                    ...
                    <form method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <input id="email" type="email" class="form-control form-control-lg{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" placeholder="Email" aria-label="Username" aria-describedby="basic-addon1"  value="{{ old('email') }}" required autofocus>
...
<div class="row border-top border-secondary">
                    ...
                    <div class="row m-t-20">
                        <!-- Form -->
                        <form class="col-12" action="{{ route('password.request') }}">
                            <!-- email -->
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
